...
while epoch_index <= max_epoch:
    ...
    if epoch_index % 2 == 0 or epoch_index == 1:
        print()
        print("Validating...")
        modelname = model_path + "resnet18_subset_crossentro_nodecay_" + str(epoch_index).zfill(4) + '.pth'
...
np.save("../Log/resnet18_subset_accuracy_list_nodecay.npy", accuracy_list_npy)
print()