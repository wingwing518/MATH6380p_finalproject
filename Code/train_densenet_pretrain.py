...
while epoch_index <= max_epoch:
    ...
    if epoch_index % 2 == 0 or epoch_index == 1:
        print()
        print("Validating...")
        modelname = model_path + "densenet121_pretrained_crossentro_clean_" + str(epoch_index).zfill(4) + '.pth'
...
np.save("../Log/densenet121_clean_accuracy_list.npy", accuracy_list_npy)
print()