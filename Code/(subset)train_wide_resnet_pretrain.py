...
while epoch_index <= max_epoch:
    ...
    if epoch_index % 2 == 0 or epoch_index == 1:
        print()
        print("Validating...")
        modelname = model_path + "wide_resnet50_2_subset_crossentro_" + str(epoch_index).zfill(4) + '.pth'
...
np.save("../Log/wide_resnet50_2_subset_accuracy_list.npy", accuracy_list_npy)
print()