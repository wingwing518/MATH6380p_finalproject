...
print()
print("Loading model...")
model_path = '../Selected_model/resnet18_subset_crossentro_nodecay_0078.pth'
print(model_path)
...
np.savetxt("Resnet18_pretrained_submission_nodecay.csv", result_list, delimiter=',', fmt='%s')
print("done")